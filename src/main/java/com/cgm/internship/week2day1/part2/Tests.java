...
//===============================================================================================
        ...
        transactions4.put("Transaction No. 5",t5);
...
//==================================================================================================
        ...
        transactions5.put("Transaction No. 5",t5);
...
//=================================================================================================
        ...
        ((TreeSet<Transaction>) transactions6).first().equals(t5);
        ...
        ((TreeSet<Transaction>) transactions6).first().setId(6);
